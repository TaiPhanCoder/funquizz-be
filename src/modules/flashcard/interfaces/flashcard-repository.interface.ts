...
export interface IFlashcardRepository {
  create(createFlashcardDto: CreateFlashcardDto, userId: string, flashcardSetId: string): Promise<Flashcard>;
  findAll(userId: string): Promise<Flashcard[]>;
  findOne(id: string, userId: string): Promise<Flashcard | null>;
